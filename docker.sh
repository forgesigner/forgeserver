...
sudo docker run -d -v /home/nikita_khramov/forger/sign-here-detector:/home/usr/forger/sign-here-detector -v /home/nikita_khramov/forger/signheredetectordataset:/home/usr/forger/signheredetectordataset -p 5000:5000 --name $SERVER_CONTAINER --restart unless-stopped $SERVER_CONTAINER
